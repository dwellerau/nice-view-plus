...
#ifndef LV_ATTRIBUTE_IMG_GLYPHS
#define LV_ATTRIBUTE_IMG_GLYPHS
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_GLYPHS uint8_t
    glyphs_map[] = {
#if CONFIG_NICE_VIEW_WIDGET_INVERTED
        0xff, 0xff, 0xff, 0xff, /*Color of index 0*/
        0x00, 0x00, 0x00, 0xff, /*Color of index 1*/
